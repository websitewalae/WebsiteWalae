...
export const DEFAULT_PRICING: Omit<PricingPackage, "id" | "created_at" | "updated_at">[] = [
  ...
  },
  {
    ...
    service_name: "WordPress + Shopify",
    slug: "wordpress-shopify",
    category: "E-COMMERCE / WEBSITE",
    price: "₹7K–₹50K+",
    starting_price: "₹7,000",
    pricing_label: "Starting From",
    description: "Professional websites and online stores built on WordPress or Shopify, depending on your business requirements.\n---\nWordPress: ₹7K–₹30K+\nShopify: ₹20K–₹50K+",
    features: ["Custom website/store setup", "Responsive design", "Theme customization", "Product/catalog setup", "Payment integration", "SEO-ready structure"],
    popular: true,
    cta_text: "Select Plan",
    cta_link: "/start-a-project?service=WordPress+Shopify",
    display_order: 2,
    active: true,
  },
  {
  ...
  },
  {
    ...
    pricing_label: "Starting From",
    description: "Management + ad spend. Facebook and Instagram advertising campaigns with audience targeting, creative testing, and lead generation.",
  ...
  },
  {
    ...
    pricing_label: "Starting From",
    description: "Basic/design scope; complex apps may cost more. Professional interface design with wireframes, prototypes, and design systems.",
  ...
  },
  {
    ...
    starting_price: "₹15,000",
    pricing_label: "Starting From",
    description: "Premium PR may cost more. Digital PR, media outreach, press releases, and online reputation management.",
